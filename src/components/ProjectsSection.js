...
const projects = [
  {
    ...
    getImageSrc: () => require("../images/photo1.jpg").default,
  },
  {
    ...
    getImageSrc: () => require("../images/photo2.jpg").default,
  },
  {
    title: "Photo Gallery",
    ...
    getImageSrc: () => require("../images/photo3.jpg").default,
  },
  {
    title: "Event planner",
    ...
    getImageSrc: () => require("../images/photo4.jpg").default,
  },
];
